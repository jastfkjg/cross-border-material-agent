...
- [manager,creative-plan,copy,final-review][hard] Treat reconciled_fact_ledger as authoritative for buyer-facing appearance claims: do not publish or regenerate from a source title or indexed attribute whose decision is reject or machine_only; use canonical_visual_claims for the resolved appearance instead.
