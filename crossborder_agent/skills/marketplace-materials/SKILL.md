---
name: marketplace-materials
description: Generate and review localized marketplace copy, hero/detail images and short product video under the task contract.
---
...
- [copy][hard] Keep buyer prose and media descriptions in the requested locale. Apply source-script rejection only to that buyer-facing layer; the separate machine appendix may preserve an exact source identifier, URL, model code or proper label when translating it would lose evidence.
- [copy][soft] Localize machine-appendix display labels when reliable, but do not discard otherwise natural buyer copy because an exact source-script value remains in the evidence layer.
...
- [creative-plan][soft] Keep the set coherent through product identity and restrained art direction while allowing role-appropriate variation in palette, background, lighting, framing and product coverage.
- [final-review][hard] At least five of six images must be independently usable; physical validity or perceptual difference alone does not satisfy a missing or duplicated role.
- [final-review][hard] A collage is defective only when it is unexpected, unreadable, duplicative or conflicts with the assigned role; a clean verified-variant composition is allowed.
- [final-review][hard] Final assets must remove non-product overlays, watermarks, contact details, QR codes, prices, platform marks and unrelated scene branding while preserving verified intrinsic product prints, embroidery, labels and marks.
- [final-review][soft] Prefer culturally neutral, natural US, Korean and Brazilian presentation without flags, landmarks, stereotypes or body reshaping.
